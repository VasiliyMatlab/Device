...
Данное сообщение предназначено для пересылки из ВПИ в ВПО команд по установлению/снятию состояний и режимов работы Устройства и Табло.

Заголовок = 0b0001  
Размер N = 1 или 5 байт  
Структура (здесь и далее "X" - произвольное значение):
| № бита | Значение| Назначение                                 |
| :----: | :-----: | :----------------------------------------- |
| 0-3    | 0001    | Отключить ВПО                              |
| 0-3    | 0010    | Включить ВПО                               |
| 0-3    | 0011    | Отключить Панель                           |
| 0-3    | 0100    | Включить Панель                            |
| 0-3    | 0101    | Отключить Табло                            |
| 0-3    | 0110    | Включить Табло                             |
| 0-3    | 0111    | Подать команды на Табло                    |
| 4-7    | XXXX    | Выравнивание на байт                       |
| 8-11   | XXXX    | ЭКТ №1 (только при подаче команд на Табло) |
| 12-15  | XXXX    | ЭКТ №2 (только при подаче команд на Табло) |
| 16-19  | XXXX    | ЭКТ №3 (только при подаче команд на Табло) |
| 20-23  | XXXX    | ЭКТ №4 (только при подаче команд на Табло) |
| 24-27  | XXXX    | ЭКТ №5 (только при подаче команд на Табло) |
| 28-31  | XXXX    | ЭКТ №6 (только при подаче команд на Табло) |
| 32-35  | XXXX    | ЭКТ №7 (только при подаче команд на Табло) |
| 32-35  | XXXX    | ЭКТ №8 (только при подаче команд на Табло) |


<a name="VPO-VPI"/><h4>ВПО-ВПИ</h4>
Данное сообщение предназначено для пересылки из ВПО в ВПИ информации о состоянии и режимах работы Устройства и Табло.
...
| № бита | Значение| Назначение                     |
| :----: | :-----: | :----------------------------- |
| 0      | 0       | Устройство в состоянии ОТКЛ    |
| 0      | 1       | Устройство в состоянии ВКЛ     |
| 1      | 0       | Устройство в режиме ЛУ         |
| 1      | 1       | Устройство в режиме ВУ         |
| 2      | 0       | Нет связи с Панелью            |
| 2      | 1       | Есть связь с Панелью           |
| 3      | 0       | Нет связи с компонентом Табло  |
| 3      | 1       | Есть связь с компонентом Табло |
| 4-7    | XXXX    | ЭКТ №1                         |
| 8-11   | XXXX    | ЭКТ №2                         |
| 12-15  | XXXX    | ЭКТ №3                         |
| 16-19  | XXXX    | ЭКТ №4                         |
...
| 28-31  | XXXX    | ЭКТ №7                         |
| 32-35  | XXXX    | ЭКТ №8                         |
| 36-39  | XXXX    | Выравнивание на байт           |
